        ...
        <div class="col-md-7">
            ...
            <section id="datos">
                <div class="card">
                    ...
                    <div class="p-4">
                        <table class="table table-hover align-middle tabla_datos " width="50">
                            <thead>
                                <tr>
                                    <th scope="col1">#</th>
            ...
            <div class="card">
                ...
                <form action="regisWeb.php" class="p-4" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="descripcion" class="form-control" cols="40" rows="4" required="" placeholder="Ingresar descripcion"></textarea>
                    </div>
                    <div class="d-grid">
